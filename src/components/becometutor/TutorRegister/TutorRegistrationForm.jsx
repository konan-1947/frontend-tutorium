...
import { useRegisterTutor } from '../../../hooks/tutor/registerTutor';
...
const TutorRegistrationForm = () => {
  ...
  useEffect(() => {
    const handleBeforeUnload = (event) => {
      // Không cần event.preventDefault() trong beforeunload
      // Gán event.returnValue để hiển thị cảnh báo mặc định của trình duyệt
      event.returnValue = ""; // Chuỗi rỗng là đủ để trình duyệt hiển thị thông báo mặc định
    };
